...
def generate_launch_description():
    ...
    return LaunchDescription([
        # Node for sample_hrnet_pose_estimation
        Node(
            package='sample_hrnet_pose_estimation',  # Replace with the actual package name
            executable='qrb_ros_hr_pose_estimation',  # Replace with the actual executable name
