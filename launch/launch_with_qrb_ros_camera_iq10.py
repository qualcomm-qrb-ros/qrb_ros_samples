...
def generate_launch_description():
    model_path_arg = DeclareLaunchArgument(
        ...
        description="Path to the hand-detection model files",
    )
    ...
    qrb_ros_camera_container = ComposableNodeContainer(
        ...
        composable_node_descriptions=[
            ComposableNode(
                ...
                remappings=[
                    ("/camera_info", "/cam5_stream1_camera_info"),
                    ("/cam5_stream1", "/image_raw"),
                ],
            ),
        ],
        output="screen",
        ...
        parameters=[
            {
                ...
                "model_path": PathJoinSubstitution(
                    [model_path, "MediaPipeHandDetector.bin"]
                ),
            }
        ],
        remappings=[
        ...
        parameters=[
            {
                "backend_option": "/usr/lib/libQnnHtp.so",
                "model_path": PathJoinSubstitution(
                    [model_path, "MediaPipeHandLandmarkDetector.bin"]
                ),
            }
        ],
        remappings=[
