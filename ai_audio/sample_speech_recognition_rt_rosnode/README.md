...
wget https://huggingface.co/qualcomm/Whisper-Tiny-En/resolve/main/WhisperEncoder.tflite?download=true -O whisper_tiny_en-whisperencoder.tflite
# Download DECODING MODEL to ./qrb_ros_samples/ai_audio/sample_speech_recognition_rt_rosnode/model.
wget https://huggingface.co/qualcomm/Whisper-Tiny-En/resolve/main/WhisperDecoder.tflite?download=true -O whisper_tiny_en-whisperdecoder.tflite
```
