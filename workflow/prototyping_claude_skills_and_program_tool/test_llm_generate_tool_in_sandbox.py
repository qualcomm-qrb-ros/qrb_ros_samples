...
if __name__ == "__main__":  
    question = "I need to split README.md into chunks"
...
[1] code_exec
  ...
  Parameters:
    - file_name (str): the file name to store your code, you should name your file intuitively , human-friendly , LLM-friendly
...
"""
    ...
    question = "split README.md into 10 chunks"
...
### ACTION SPACE
[1] code_exec
  Description: this tool will run python code clock in sandbox and only return execution results. Result string will be taken into your next inference in "Tool Use Results" part. You need to check if there is available python scripts in local to accomplish your task.
  Parameters:
    - file_name (str): the file name to store your code, you should name your file intuitively , human-friendly , LLM-friendly
    - code_block (str): the complete code block that can run in a single python file
