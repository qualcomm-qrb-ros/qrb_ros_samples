...
| [sample_depth_estimation](ai_vision/sample_depth_estimation/) | Leopard imaging camera          | N                   | Y                      | N                          | `sample_depth_estimation` is a Python-based launch file that uses QNN for DepthAnythingV2  model inference. For model information, please refer to [Depth-Anything-V2 - Qualcomm AI Hub](https://aihub.qualcomm.com/iot/models/depth_anything_v2?searchTerm=depth&domain=Computer+Vision) |
