...
| [sample followme](robotics/sample_followme) | N                    | Y                        | Y                   | Y                      | Y                          | The `sample_followme` is a AMR to detect, track, and follow a moving person in real time. It integrates sensor emulation and motion control to follow human-following behavior in real environments. This depends on Orbbec Camera to get images |
## System Requirements
